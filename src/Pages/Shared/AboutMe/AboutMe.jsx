        ...
        <section className=' m-10'>
            <div className='grid grid-cols-1 md:grid-cols-2 gap-10 items-center'>
                ...
                <div className='hover:-translate-y-4'>
                    ...
                    <a href="mailto:rakibul9bd@gmail.com" className="relative mt-5 inline-flex items-center justify-center p-0.5 mb-2 mr-2 overflow-hidden text-sm font-medium rounded-lg group bg-gradient-to-br from-purple-500 to-pink-500 group-hover:from-purple-500 group-hover:to-pink-500 hover:text-white text-white focus:ring-4 focus:outline-none focus:ring-purple-200 focus:ring-purple-800">
