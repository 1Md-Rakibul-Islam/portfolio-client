    ...
    return (
        <section className='m-10'>
            <div className='grid grid-cols-1 md:grid-cols-2 gap-10 items-center'>
                <div className='bg-base-200 border-x-4 border-base-200 hover:border-primary hover:-translate-y-4 rounded-full m-auto overflow-hidden '>
                    <img className='' src={aboutImg} alt="" />
                </div>
                <div className='hover:-translate-y-4'>
                    <h2 className='text-5xl text-purple-500 mt-10 mb-3'>About Me</h2>
                    <p className='text-lg'>
