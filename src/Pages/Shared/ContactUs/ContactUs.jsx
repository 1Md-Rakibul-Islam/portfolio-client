        ...
        <form ref={form} onSubmit={sendEmail} className="text-white my-10">
          <div className="flex md:flex-row flex-col items-center md:gap-16 gap-8">
            <div className="w-full md:w-1/2">
              <input
                ...
                className="block w-full p-4 my-7 rounded-full hover:shadow-2xl focus:outline-none focus:ring focus:ring-opacity-25 focus:ring-purple-700 bg-black"
              />
            ...
            <div className="w-full md:w-1/2">
              <textarea
                ...
                className="block w-full p-4 rounded-3xl hover:shadow-2xl autoexpand focus:outline-none focus:ring focus:ring-opacity-25 focus:ring-purple-700 bg-black"
              ></textarea>
            </div>
          </div>
          <div className="flex justify-center mt-5 md:mt-0 md:justify-end">
            <button
              type="submit"
              value="Send"
              className="focus:outline-none text-white focus:ring-4 font-medium rounded-full text-lg px-5 py-2.5 mb-2 bg-purple-700 hover:bg-purple-800 focus:ring-purple-900"
            >
              Send Message
            </button>
          </div>
