    ...
    <footer className="p-4 rounded-lg shadow md:px-6 md:py-8 bg-gray-900">
      <div className="flex justify-center gap-5">
        ...
        <ul className="flex flex-wrap items-center mb-6 text-sm sm:mb-0 text-gray-400">
          ...
          <li>
            <Link to={"/contractUs"} className="hover:underline">
              Contact
            </Link>
          </li>
        </ul>
      ...
      <div className="flex justify-center mt-2 gap-4">
        ...
        <a
          href="https://twitter.com/MrRakib17184590Link"
          target="_blank"
          rel="noopener noreferrer"
        >
          <FaTwitter
            className="text-4xl text-purple-400 mb-2 p-1 hover:border-blue-600"
            rel="noopener noreferrer"
          ></FaTwitter>
        </a>
      </div>
      ...
      <span className="block text-sm text-center text-gray-400">
        © <Link className="hover:underline">Rakibul Islam™</Link>. All Rights
        Reserved.
      </span>
    </footer>
  );
