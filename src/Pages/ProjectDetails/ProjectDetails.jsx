...
const ProjectDetails = () => {
  ...
  return (
    <section className="section-py overflow-x-hidden text-gray-100">
            ...
            <div className="mt-5 space-y-6">
              {features?.map((feature) => (
                <div className="text-xl">
                  <h5>
                    <FaCheckCircle className="text-purple-700 text-2xl inline mr-3" />
                    {feature}.
                  </h5>
                </div>
              ))}
            </div>
            <h3 className="text-2xl mt-10 font-bold tracking-tight sm:text-3xl text-gray-50">
              Techonologys
            </h3>
            ...
            <div className="flex justify-evenly items-center gap-5 md:mb-0 my-5">
              <>
                {gitHubClient && (
                  <a
                    href={gitHubClient}
                    className="flex border border-blue-700 hover:bg-black rounded-lg shadow-2xl translate-y-5 w-20 h-20 p-1 flex-col justify-center items-center"
                    target="blank"
                  >
