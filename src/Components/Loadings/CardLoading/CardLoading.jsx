...
const CardLoading = () => {
  return (
    <section className="overflow-x-hidden min-h-screen md:my-40 section-py grid grid-cols-1 justify-center items-center gap-5 md:gap-10 md:grid-cols-2 lg:grid-cols-3 md:mx-20 mx-5">
